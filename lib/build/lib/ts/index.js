 ...
 */
function printPortConfiguration(answers) {
    const FRONTEND_PORT_MAP = {
        react: "3000",
        next: "3000",
    ...
    const frontendPort = answers.frontend !== undefined ? FRONTEND_PORT_MAP[answers.frontend] || "3000" : "3000";
    const backendPort = answers.backend !== undefined ? BACKEND_PORT_MAP[answers.backend] || "3001" : "3001";
    console.log("");
